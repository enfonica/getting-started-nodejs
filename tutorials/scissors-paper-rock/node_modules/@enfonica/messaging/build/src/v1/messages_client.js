...
const gapicConfig = require("./messages_client_config.json");
...
class MessagesClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('enfonica.messaging.v1.Messages', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.messagesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('enfonica.messaging.v1.Messages')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.enfonica.messaging.v1.Messages, this._opts);
        ...
        for (const methodName of messagesStubMethods) {
            const callPromise = this.messagesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=messages_client.js.map