...
exports.UnsubscribersClient = void 0;
const gax = require("google-gax");
const localAuth = require("@enfonica/auth-library");
const path = require("path");
const gapicConfig = require("./unsubscribers_client_config.json");
...
class UnsubscribersClient {
    ...
    constructor(opts) {
        ...
        this.pathTemplates = {
            messagePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/messages/{message}'),
            unsubscriberPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/unsubscribers/{unsubscriber}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listUnsubscribers: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'unsubscribers'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('enfonica.messaging.v1.Unsubscribers', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.unsubscribersStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('enfonica.messaging.v1.Unsubscribers')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.enfonica.messaging.v1.Unsubscribers, this._opts);
        ...
        for (const methodName of unsubscribersStubMethods) {
            const callPromise = this.unsubscribersStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    createUnsubscriber(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    getUnsubscriber(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    updateUnsubscriber(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    deleteUnsubscriber(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    listUnsubscribers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    listUnsubscribersStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        this.initialize();
        return this.descriptors.page.listUnsubscribers.createStream(this.innerApiCalls.listUnsubscribers, request, callSettings);
    }
    /**
     ...
     */
    listUnsubscribersAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listUnsubscribers.asyncIterate(this.innerApiCalls['listUnsubscribers'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
     ...
     */
    matchProjectFromMessageName(messageName) {
     ...
     * @returns {string} Resource name string.
     */
    unsubscriberPath(project, unsubscriber) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromUnsubscriberName(unsubscriberName) {
     ...
     */
    matchUnsubscriberFromUnsubscriberName(unsubscriberName) {
        return this.pathTemplates.unsubscriberPathTemplate.match(unsubscriberName)
            .unsubscriber;
    }
    /**
...
exports.UnsubscribersClient = UnsubscribersClient;
//# sourceMappingURL=unsubscribers_client.js.map