...
export class JWTAccess {
   ...
   */
  async getRequestHeaders(url: string, additionalClaims?: Claims): Promise<any> {
    ...
    const defaultClaims = {
      ...
      sub: this.email,
      scope: url,
      aud: 'https://oauth2.api.enfonica.com/token',
      exp,
      iat,
    };
    ...
    try {
      const r = await request<any>({
        method: 'POST',
        url: 'https://oauth2.api.enfonica.com/token',
